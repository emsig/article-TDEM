...
\setdeletedmarkup{\color{mygreen}{\itshape \sout{#1}}}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/GUI-FFTLog-lin}
...
\begin{figure*}
  \centering
  \subfloat[]{{\includegraphics[width=.5\linewidth]{figures/GUI-FFTLog-log}}%
  \label{fig:GUI-FFTLog-log}}\hfill
  \subfloat[]{{\includegraphics[width=.5\linewidth]{figures/GUI-DLF-lin}}%
...
\begin{figure}
  \centering
  \includegraphics[width=.8\linewidth]{figures/multi-offset}
...
\begin{figure*}
  \centering
  \includegraphics[width=\linewidth]{figures/fullspace}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/fullspace-log}
...
\begin{figure*}
  \centering
  \includegraphics[width=.8\linewidth]{figures/marine}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/marine-multioffset}
...
\begin{figure*}
  \centering
  \includegraphics[width=.8\linewidth]{figures/marine-wrong-x-y}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/3d-model}
...
\begin{figure*}
  \centering
  \includegraphics[width=.8\linewidth]{figures/3d-result}
