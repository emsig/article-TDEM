...
\title[Transforming expensive EM kernels]{Fast Fourier transform
...
\date{Accepted 2021 April 20. Received 2021 April 7; in original form 2020 June 30}
\pagerange{1336--1347}
\volume{226}
\pubyear{2021}
...
\begin{summary}
%
Three-dimensional controlled-source electromagnetic data are often computed
...
The speed of modelling obtained through such a transform is defined by three
key points: solver, method and implementation of the Fourier transform, and
gridding.
%
...
carefully at these points resulted in much smaller computation times with
...
CSEM codes for arbitrary 2D and 3D computations, on the other hand, often
compute their responses directly in the required domain, either frequency or
time.
...
of $O(n^4\sqrt{\log n})$, and Fourier transforms of frequency-domain solutions
...
comprise in of a homogeneous space, a layered model, a model which includes
...
differently for other mesh types or a time-domain code, some conclusions will
still hold.
...
a very small cell stretching factor $\alpha_\mr{s}$. The minimum cell width is
defined as
%
\begin{equation}
...
inline offset of 900\,m are placed on the surface. The real and imaginary
