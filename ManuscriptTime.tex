...
two 3D codes as a percentage, where
\old{$\mr{ND}= 50|(\simpeg-\emg3d)/(\simpeg+\emg3d)|$.}
\new{$\mr{ND}= 200|\simpeg-\emg3d|/(|\simpeg|+|\emg3d|)$.}
The ND between the two codes is below 1\,\% everywhere except for early times.
