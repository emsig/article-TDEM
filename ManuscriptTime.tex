...
\ifthenelse{\boolean{GJ@referee}}{%
  \newcommand{\cwidth}{234pt}%
  \newcommand{\fwidth}{468pt}%
  \newcommand{\twidth}{468pt}}{%
  \newcommand{\fwidth}{504pt}%
  \ifthenelse{\boolean{@twocolumn}}{%
    \newcommand{\cwidth}{240pt}%
    \newcommand{\twidth}{240pt}}{%
    \newcommand{\cwidth}{252pt}%
    \newcommand{\twidth}{504pt}%
  }
}
...
% \setaddedmarkup{\color{myred}{#1}}
\setaddedmarkup{\color{myred}{#1}}
\setdeletedmarkup{\color{mygreen}{\sout{#1}}}
...
\title[Time-domain CSEM]{Fast time-domain electromagnetic modelling in the frequency domain}
...
\author[D. Werthmüller \emph{et al.}]
  ...
  E-mail: \href{mailto:Dieter@Werthmuller.org}{Dieter@Werthmuller.org}\\[-.3em]
   \footnotesize
  $^2$ Shell Global Solutions International BV, Grasweg 31, 1031 HW Amsterdam(NL)
  }
...
%
Looking carefully at these three \added{key} points results in much smaller
...
\begin{figure}
  \centering
  \includegraphics[width=\cwidth]{GUI-FFTLog-lin}
...
\begin{figure*}
  \centering
  \subfloat[]{{\includegraphics[width=\cwidth]{GUI-FFTLog-log}}%
  \label{fig:GUI-FFTLog-log}}\hfill
  \subfloat[]{{\includegraphics[width=\cwidth]{GUI-DLF-lin}}%
...
\begin{figure}
  \centering
  \includegraphics[width=\cwidth]{multi-offset}
...
\begin{figure*}
  \centering
  \includegraphics[width=\fwidth]{fullspace}
...
\begin{figure}
  \centering
  \includegraphics[width=\cwidth]{fullspace-log}
...
\begin{figure*}
  \centering
  \includegraphics[width=\fwidth]{marine}
...
\begin{figure}
  \centering
  \includegraphics[width=\cwidth]{marine-multioffset}
...
\begin{figure*}
  \centering
  \includegraphics[width=\fwidth]{marine-wrong-x-y}
...
\begin{figure}
  \centering
  \includegraphics[width=\cwidth]{3d-model}
...
\begin{figure*}
  \centering
  \includegraphics[width=\fwidth]{3d-result}
