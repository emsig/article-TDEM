...
\added{BEGIN TEMPORARY ADDED v v v v}
...
\added{END TEMPORARY ADDED n n n}
...
\added{$\Downarrow\qquad$ Note to reviewers: The entire section 4.3 below is
new, without being all marked in green. $\qquad\Downarrow$}
...
\added{$\Uparrow\qquad$ Note to reviewers: The entire section 4.3 above is new,
without being all marked in green. $\qquad\Uparrow$}
