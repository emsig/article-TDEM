...
frequencies are ideally equally spaced on a logarithmic scale. We present a
fast frequency-to-time domain method using either the digital linear filter
method or the logarithmic fast Fourier transform together with careful
selection of frequencies and interpolation. 15 to 20 frequencies are generally
enough with this methodology to cover a wide range of offsets in
one-dimensional test models.
%
